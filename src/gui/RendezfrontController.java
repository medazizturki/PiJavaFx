...
public class RendezfrontController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       playMusic();
        ...
        usertf.setText(String.valueOf(userId));
        // TODO
    }    
               String path = "C:\\xampp2\\htdocs\\music\\Enregistrement.m4a";
 ...
 try {
    ...
    private void ajouterrendezvous(ActionEvent event) {
         ...
         int part=0;
        if ((nomtf.getText().length() == 0) || (prenomtf.getText().length() == 0) || (lieutf.getText().length() == 0) || (usertf.getText().length() == 0)) {
